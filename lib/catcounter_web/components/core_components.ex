defmodule CatcounterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(CatcounterWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(CatcounterWeb.Gettext, "errors", msg, opts)
    # end
